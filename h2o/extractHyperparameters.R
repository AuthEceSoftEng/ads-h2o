...
dataset_path <- files_list[[1]]
dataset_name <- substr(dataset_path,1,nchar(dataset_path)-4)
a = paste(repo, dataset_path, sep = "/")
df <- h2o.importFile(path = normalizePath(a))
response <- "Class"
...
test = cbind(info,parameters)
write.csv(test, "./Documents/Github/ads-h2o/h2o/h2o_test.csv")
